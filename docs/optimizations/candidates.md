...
2 s step loop) and conv-conv's second-conv accumulate at B = 32 (threaded over column chunks)
run products above 8M flops. Revisit only for a large-batch use case:
